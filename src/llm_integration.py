"""
llm_integration.py
LLM API integration layer. Supports OpenAI.
...
class LLMClient:
    """
    OpenAI API client with retry logic and structured output handling.
    """
    ...
    def _init_client(self):
        ...
        try:
            ...
            print(f"[LLM] Initialized OpenAI client | Model: {self.model}")
        except ImportError:
            raise ImportError(
    ...
    def generate(
        ...
        """
        Generate content from the LLM with retry logic.
    ...
    def generate_with_template(
        ...
        **kwargs,
        ...
        """
        Generate content using a PromptTemplate object.
        Automatically fills template variables from topic, kb_context, and extra_vars.
        """
    ...
    def check_context_limit(self, *texts: str, limit: int = 128_000) -> bool:
        """Check if combined text is within context limits (gpt-4o-mini: 128k)."""
